    ...
    <div>
         <div class="md:flex md:flex-wrap md:-mx-4 mt-6 md:mt-12">
          ...
          <div class="md:w-1/3 md:px-4 xl:px-6 mt-8 md:mt-0 text-center">
            ...
            <p class="text-gray-600">FWR blocks bring in an air of fresh design with their creative layouts and blocks,
          ...
          <div class="md:w-1/3 md:px-4 xl:px-6 mt-8 md:mt-0 text-center">
            ...
            <p class="text-gray-600">FWR blocks is a perfect tool for designers, developers and agencies looking to
              create stunning websites in no time.</p>
          </div>
