    ...
    <nav class="bg-white py-2 md:py-4">
      <div class="container px-4 mx-auto md:flex md:items-center">
        ...
        <div class="flex justify-between items-center">
          <nuxt-link :to="{ name: 'index'}" class="font-bold text-xl text-indigo-600">FWR</nuxt-link>
          <button
        ...
        <div class="hidden md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
          ...
          <nuxt-link :to="{ name: 'about'}"
            class="p-2 lg:px-4 md:mx-2 text-gray-600 rounded hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300">About</nuxt-link>
          <nuxt-link :to="{ name: 'shop'}"
            class="p-2 lg:px-4 md:mx-2 text-gray-600 rounded hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300">Shop</nuxt-link>
          <a href="#"
          ...
          <nuxt-link :to="{ name: 'login'}"
            class="p-2 lg:px-4 md:mx-2 text-indigo-600 text-center border border-transparent rounded hover:bg-indigo-100 hover:text-indigo-700 transition-colors duration-300">Login</nuxt-link>
          <a href="#"
